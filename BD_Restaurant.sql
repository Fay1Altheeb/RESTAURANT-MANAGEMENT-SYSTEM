...
INSERT INTO BRANCH (Branch_Code , City , Neighborhood , Street , Capacity, Open_Time, Close_Time, Menu_ID, Manager_ID)
values
    (1, 'Riyadh', 'Al-Sulaimaniya', 'King Saud Road', 100,'7:00', '12:00' , 1,null),
    (2, 'Riyadh', 'Alaqiq', 'Kafd ring roud', 150,'7:00', '12:00', 1,null),
    (3, 'Riyadh', 'alsafarat', 'Alkhawaba', 100,'7:00', '12:00', 1,null);
...
VALUES
    (12534, 'Lama', 26, 'Female', '966599777888', 'lama123@gmail.com', 'Manager', 23456, 12000,1),  
    (12536, 'Hanin', 20, 'Female', '966599899399', 'hanin123@gmail.com', 'Chef', 12345, 10000,1),  
	(12537, 'Nouf', 30, 'Female', '966599666777', 'nouf_barista@gmail.com', 'Barista', 34567, 9000,1),
	(12540, 'khaled', 25, 'Male', '966599555666', 'khaled123@gmail.com', 'Cashier', 45678, 8500,1),  
    (12535, 'Fay', 26, 'Female', '966599777253', 'fay_123@gmail.com', 'Manager', 45363, 12000,2),  
    (12539, 'Yasser', 20, 'Male', '966599899334', 'yasser123@gmail.com', 'Chef', 97865, 10000,2),  
	(12538, 'Yara', 30, 'Female', '966599666745', 'yara353@gmail.com', 'Barista', 12323, 9000,2),
	(12541, 'Nawaf', 25, 'Male', '966599555667', 'Nawaf45@gmail.com', 'Cashier', 98675, 8500,2),
    (12522, 'Ahmed', 28, 'Male', '966598888345', 'ahmed_123@gmail.com', 'Manager', 34521, 12000,3),  
	(12523, 'Omar', 35, 'Male', '966599444963', 'omar_chef@gmail.com', 'Chef', 76859, 10000,3),
	(12524, 'Demma', 30, 'Female', '966599666711', 'domo@gmail.com', 'Manager', 49374, 9000,3),
    (12525, 'noura', 24, 'Female', '966599555634', 'noura123@gmail.com', 'Cashier', 98743, 8500,3); 
...
values
   ...
   (15, 'Coffe', 'Pink late', 'Regular Mile, Espresso, ', 18, 243,1),
   (16, 'Coffe', 'Iced Vanilla Matcha', 'Vanilla Syrup, Matcha Regular Milk, Ice', 24, 204,1),
...
INSERT INTO BILL(Bill_Number, Payment_method, State, Bill_Date, Order_Number) 
VALUE 
(1,'Apple Pay',true, NULL,1);
